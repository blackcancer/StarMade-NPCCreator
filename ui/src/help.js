...
export function initHelpPanel(lang = "en") {
  ...
  const map = {
    fr: [
      ["Integrated guide","Guide intégré"],["StarMade NPC Creator Help","Aide StarMade NPC Creator"],["Build NPC dialog trees visually, generate Lua automatically, then import the Lua back without losing structure when possible.","Créez des arbres de dialogue NPC visuellement, générez du Lua automatiquement, puis réimportez le Lua en conservant la structure autant que possible."],["Quick workflow","Flux de travail rapide"],["Start with a Greeting","Commencez par un bloc Accueil"],["Add Choice","Ajoutez des blocs Choix"],["Attach actions","Attachez des actions"],["Read the Lua Output","Lisez la Sortie Lua"],["Export JSON","Exportez en JSON"],["Download Lua","Téléchargez le Lua"],["Dialog basics","Bases du dialogue"],["required root node","nœud racine requis"],["Go Back","Retour"],["Branches vs 🧩 Expressions","Branches vs 🧩 Expressions"],["Variables","Variables"],["Text placeholders","Variables de texte"],["Block categories — quick reference","Catégories de blocs — référence rapide"],["Quest system","Système de quêtes"],["Persistence (HSQLDB)","Persistance (HSQLDB)"],["Comments","Commentaires"],["Disabled blocks","Blocs désactivés"],["Import / Export","Import / Export"],["Good practice","Bonnes pratiques"],["Known limitations","Limites connues"],["Installing the Lua in StarMade","Installer le Lua dans StarMade"],["Launch StarMade and join your server as an admin.","Lancez StarMade et rejoignez votre serveur en tant qu'administrateur."],["Talk to the NPC — the new dialog is active immediately (no restart required).","Parlez au NPC — le nouveau dialogue est actif immédiatement (aucun redémarrage requis)."]
    ],
    de: [["Integrated guide","Integrierter Leitfaden"],["StarMade NPC Creator Help","StarMade NPC Creator Hilfe"],["Quick workflow","Schneller Ablauf"],["Dialog basics","Dialog-Grundlagen"],["Import / Export","Import / Export"],["Installing the Lua in StarMade","Lua in StarMade installieren"]],
    es: [["Integrated guide","Guía integrada"],["StarMade NPC Creator Help","Ayuda de StarMade NPC Creator"],["Quick workflow","Flujo rápido"],["Dialog basics","Conceptos básicos de diálogo"],["Import / Export","Importar / Exportar"],["Installing the Lua in StarMade","Instalar Lua en StarMade"]]
  };
  let html = HELP_HTML;
